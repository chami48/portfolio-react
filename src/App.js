...
const projects = [
  ...
  },
  {
    ...
    github:
      "https://github.com/chami48/Internship-and-Job-preparation-platform",
  },
...
const educationItems = [
  ...
  },
  {
    ...
    meta: "2025 - Present · Ongoing\n Part-time diploma program focused on foundational psychology concepts, theories, and applications.",
  },
  {
    ...
    >
      ...
      <nav className={scrolled ? "nav nav-scrolled" : "nav"}>
        <div className="nav-inner">
          <div className="nav-logo">Dilmi Chamya</div>
      ...
      <main>
            ...
            <div className="hero-grid">
              ...
              <div className="hero-copy">
                ...
                <p className="hero-text">
                  Hey, I&apos;m Dilmi Chamya. Passionate undergraduate seeking
                  internship opportunities in Software Engineering,
                  Frontend/Backend Development, Full-Stack Development, UI/UX
                  Design, and QA Testing. I love building innovative solutions
                ...
                <div className="social-row">
                  ...
                  <a
                    className="social-link"
                    href="mailto:dilmichamya@example.com"
                  >
                    <Mail size={22} strokeWidth={1.5} />
                  </a>
                  <a
                    className="social-link"
                    href="https://www.instagram.com/chamya_nadakanda"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
              ...
              <div className="hero-image">
                <div className="image-wrapper">
                  <img src="/profile.jpeg" alt="Dilmi Chamya" />
                </div>
              </div>
            </div>
          </div>
        ...
        <section
          id="certifications"
          className="section certifications-section reveal"
        >
          <div className="section-header">
        ...
        <section id="projects" className="section reveal">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Explore my academic and personal projects that demonstrate my
              technical abilities.
            </p>
          </div>
        ...
        <section id="contact" className="section reveal">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              ...
              apply my skills, contribute to meaningful projects, and grow as a
              software professional. Let&apos;s connect and build something
              amazing together!
            </p>
          </div>
          ...
          <div className="contact-card">
            <a
              ...
              href="mailto:dilmichamya48@gmail.com"
            >
